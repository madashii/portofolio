                ...
                p-20 md:p-44 h-screen'>
                        ...
                        <div className='space-y-10 px-0 md:px-10 max-w-6xl'>
                            ...
                            <p className=' text-lg text-center md:text-left'>
                                ...
                                esse recusandae, commodi molestias dignissimos quisquam dolor, mollitia 
                                impedit quis explicabo? Voluptate perspiciatis dolorem beatae, inventore
                                 saepe atque assumenda dolor.
                            </p>
                        </div>
                    </div>
                ))}
